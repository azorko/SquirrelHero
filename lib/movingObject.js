  ...
  MovingObject.prototype.isCollidedWith = function(otherObject) {
		...
		if (this instanceof SquirrelHero.FlyingCow) {
		  ...
		  dist = distance(this.pos, actualPos);
			...
			dist = distance(thisActualPos, otherActualPos);
		} else if (this instanceof SquirrelHero.Squirrel && otherObject instanceof SquirrelHero.Basket) {
			var thisActualPos = [this.pos[0] + 38.5, this.pos[1] + 27];
			var otherActualPos = [otherObject.pos[0] + 90, otherObject.pos[1] + 47];
			dist = distance(thisActualPos, otherActualPos);
		} else if (otherObject instanceof SquirrelHero.Squirrel && this instanceof SquirrelHero.Basket) {
			var thisActualPos = [this.pos[0] + 90, this.pos[1] + 47];
			var otherActualPos = [otherObject.pos[0] + 38.5, otherObject.pos[1] + 27];
			dist = distance(thisActualPos, otherActualPos);
		}
