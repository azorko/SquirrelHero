(function (rootObject) {
  ...
  MovingObject.prototype.isCollidedWith = function(otherObject) {
		var dist;
		if (this instanceof Asteroids.Ship || otherObject instanceof Asteroids.Ship) { return false; }
		if (this instanceof Asteroids.Asteroid) {
			var actual_pos = [this.pos[0] + 63.5, this.pos[1] + 38.5];
			dist = distance(actual_pos, otherObject.pos);
		} else if (otherObject instanceof Asteroids.Asteroid) {
			var actual_pos = [otherObject.pos[0] + 63.5,otherObject.pos[1] + 38.5];
		  dist = distance(this.pos, actual_pos);
		}
